...
class TestRActivity : AppCompatActivity() {
    ...
    private fun initData() {
        ...
        var moneyAccount = MoneyAccountWithDetails()
...
//            moneyAccountViewMode.addAccount(MoneyAccount(0, "Vu Duc Cuong", 122222F,false,1,1,1,1))
            ...
            moneyAccountViewMode.moneyAccountsWithDetails.observe(this) {
                for (i in it) {
                    if (i.moneyAccount!!.idMoneyAccount == 2) {
        ...
        binding.btAddColor.setOnClickListener {
            moneyAccount.moneyAccount!!.moneyAccountName = "new"
            moneyAccount.country!!.countryName = "new"
            moneyAccount.account!!.accountName = "new"

            moneyAccountViewMode.updateMoneyAccountWithDetails(moneyAccount)
        }
